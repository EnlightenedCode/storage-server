...
package com.risevision.medialibrary.server.amazonImpl;
...
public class ListAllMyBucketsResponse extends Response {
    ...
    public ListAllMyBucketsResponse(HttpURLConnection connection) throws IOException, ServiceFailedException {
        ...
        if (connection.getResponseCode() < 400) {
        	listAllMyBuckets(connection.getInputStream());
        }
    }

    public ListAllMyBucketsResponse(InputStream inputStream) throws IOException, ServiceFailedException {
    	super(null);
    	
    	listAllMyBuckets(inputStream);
    }
    
    public void listAllMyBuckets(InputStream inputStream) throws IOException, ServiceFailedException {
        try {
